...
function install-binary {
    ...
    BINARY_URL="https://github.com/NavigatingCancer/local-persist/releases/download/${VERSION}/local-persist-${OS}-${ARCH}"
...
function setup-systemd {
    SYSTEMD_CONFIG_URL="https://raw.githubusercontent.com/NavigatingCancer/local-persist/${VERSION}/init/systemd.service"
...
function setup-upstart {
    UPSTART_CONFIG_URL="https://raw.githubusercontent.com/NavigatingCancer/local-persist/${VERSION}/init/upstart.conf"
